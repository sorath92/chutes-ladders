 ...
 * 
 * This validates the game rules . For example : Our Chutes and Ladders game should have between 2 to 4 players. 
 * 
 * Once validation is done it instantiates the sample Game. This Game is played in the main class to generate result for the players. 
 * 
