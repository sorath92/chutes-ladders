...
/**
 * This class represents the game play of chute and Ladders. Here is where the fun starts.  
 * 
...
public class ChuteAndLadders {
	 ...
	 * This Plays the game. 
	 * 
	 * It returns an integer which can be used for logging like how many games were played etc. 
	 * 
	 * 
	 */
	...
	public static int playStandardChuteAndLadders(String [] playerNames) {
		...
		// All players roll the dice once to get a number between 1 - 6 . The player who gets highest gets the first chance. 
		...
		while(winnerDeclared == false) {
			...
			for(Player p:orderList) {
				...
				// check if the new position is beyond the win Position which is 100. When such a thing happens Player skips turn
		...
		return 1; // return 0 if the game is not played. 1 if the game is played for logging purpose. 
	}
